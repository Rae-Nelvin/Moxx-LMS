                    ...
                    <div class="lg:px-5">
                        @foreach ($plan as $plans)
                            <div
                                ...
                                <h5 class="mb-4 text-xl font-medium text-gray-500 dark:text-gray-400">{{ $plans->title }}
                                </h5>
                                    ...
                                    @foreach ($planDetail as $planDetails)
                                        @if ($planDetails->planID == $plans->id)
                                            <li class="flex space-x-3">
                                                <svg class="flex-shrink-0 w-5 h-5 icon-ctg" fill="currentColor"
        ...
        @foreach ($mentor as $mentors)
            <div class="our-mentor my-12 grid lg:grid-cols-12">
                <div class=" lg:col-span-3 lg:col-end-6">
                    @if ($mentors->avatarID)
                        <img class="rounded-full w-52 overflow-hidden mx-auto"
                            src="{{ asset('storage/' . $mentors->photo->imageURl) }}" alt="Bonnie image">
                    @endif
                    <img src="{{ asset('images/guest-icon/dummy-icon') }}" alt="mentor"
                        class="rounded-full w-52 overflow-hidden mx-auto">
                </div>

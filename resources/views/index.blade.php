...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-white">
            <div class="container">
                ...
                <div class=" collapse navbar-collapse" id="navbarNav">
                    ...
                    <div class="md:px-5">
                        <button class="btn btn-outline-primary rounded-full">Login</button>
                    </div>
                    <div class="btn-register">
                        <button class="btn btn-outline-primary rounded-full">Register</button>
                    </div>
                </div>
            </div>
        </nav>
    ...
    <div class="slide-1 overflow-hidden">
        <div class="row">
            <div class="w-full h-auto w-screen" id="slide">
                <!-- <img src="images/slide-2.jpg" class="bg object-cover w-full h-full "> -->
                <div class="md:px-28 md:mt-28 text-black get-started-text ">
                    ...
                    <div class="btn-start my-5">
                        <!-- <button class="btn btn-outline-primary rounded-lg">Register for free now
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="why-card md:flex md:flex-row md:items-center md:justify-center w-full">
                    <div class="px-5">
                        <div
                            class="card-course p-4 max-w-sm rounded-lg border shadow-md sm:p-8 dark:bg-gray-800 dark:border-gray-700 mt-20">
                            ...
                            <ul role="list" class="my-7 space-y-5">
                                <li class="flex space-x-3">
                                    <svg class="flex-shrink-0 w-5 h-5 text-blue-600 dark:text-blue-500"
                            ...
                            <button type="button"
                                class="btn-why text-black font-medium rounded-lg text-sm px-5 py-2.5 inline-flex justify-center w-full text-center">Choose
                                plan</button>
                        </div>
                    </div>
                    <div class="px-5">
            ...
            <div class="row">
                ...
                <div class="course-content md:my-24 max-w-screen-xl mx-auto my-12">
                    <div class="w-full md:grid md:grid-cols-12 md:gap-4 md:mt-20 ">
                        ...
                        <div
                            class="md:col-span-3 md:col-start-8 flex items-center justify-center my-12 md:order-sm-start">
                            <img class="object-cover md:w-72 w-72" src="images/item_bootcamp.png" alt=" course-img">
                        </div>
                        <!-- bagian 2 -->
                        <!-- bagian 3 -->
    ...
    <section class="mentor mx-auto my-24 max-w-screen-xl w-full">
        ...
        <!-- <div class="w-full p-3 my-12">
            <div class="flex rounded items-center justify-center overflow-hidden h-auto lg:h-32 ">
                <img class="h-auto w-full object-fill lg:w-48 rounded-full" src="images/jungkook.jpg" alt="img">
                <div class="p-4 flex flex-col justify-between leading-normal">
                    <div class="text-black font-bold text-xl mb-2 leading-tight">Mr. Rhemzy Putra Maulana
    ...
    <section class="my-12 max-w-screen-xl mx-auto" id="testimonal">
        ...
        <div class="mt-20 grid md:grid-cols-3">
            <div class="max-w-sm py-4 px-8 bg-white shadow-lg rounded-lg my-20">
                <div class="flex justify-center md:justify-end -mt-16">
                    <img class="w-20 h-20 object-cover rounded-full border-2 border-indigo-500" alt="img"
        ...
        <div class="flex justify-center mt-10">
            <div class="mb-3 xl:w-96 ">
                <div class="input-group relative flex flex-wrap items-stretch w-full mb-4 ">
                    ...
                    <button
                        class="btn inline-block px-6 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded-full shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700  focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out flex items-center"

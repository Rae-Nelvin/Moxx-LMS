...
@section('content')
    ...
    <form action="{{ route('tutor.newClass') }}" method="POST" class="flex flex-row justify-between mt-[46px] space-x-10" enctype="multipart/form-data" id="courseForm">
        @csrf
        ...
        <div class="relative p-4 w-full max-w-md h-full md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="py-6 px-6 lg:px-8">
                    <h3 class="mb-4 text-xl font-medium text-gray-900">New Class Type</h3>
                    <form action="{{ route('tutor.storeType') }}" method="POST" id="courseType">
                        @csrf
                        <div>
                            <label for="email" class="block mb-2 text-sm font-medium text-gray-900 ">New Class Type</label>

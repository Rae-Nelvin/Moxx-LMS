        ...
        <form action="{{ route('admin.login') }}" method="POST" class="w-full">
            ...
            <div class="mb-[18px]">
                ...
                <input type="email" id="email" name="email"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-md focus:ring-[#14F6B5] focus:border-[#14F6B5] block w-full p-2.5 "
            ...
            <button
                class="text-[#FDF9F7] bg-[#50CFAB] hover:bg-[#46b495] focus:ring-2 focus:outline-none focus:ring-[#14F6B5] font-medium rounded-md text-xl sm:w-full px-5 py-2.5 text-center transition-all ease-in-out duration-300">Login</button>
        </form>
    </div>
</body>

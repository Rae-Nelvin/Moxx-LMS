...
@section('content')
    <div class="flex flex-col justify-between space-y-10">
        <div class="flex flex-col flex-nowrap pr-[126px]">
            ...
            <div class="flex flex-row mt-2 justify-between space-x-10">
                <img src="{{ asset('storage/' . $course->photo->imageURL) }}" alt="cover-img" class="w-3/4 mt-2">
                                    ...
                                    <div class="py-3 px-5 flex flex-col space-y-4 w-full">
                                        @foreach ($lesson as $lessons)
                                            @if ($lessons->lessonGroupID == $lessonGroups->id)
                                                <a
                                                    href="/admin/course/detail/{{ $course->id }}/{{ $lessonGroups->id }}/{{ $lessons->id }}">

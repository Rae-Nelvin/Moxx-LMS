...
<div class="flex flex-col flex-nowrap pr-[126px]">
    ...
    <div class="flex flex-row mt-11 justify-between space-x-10">
        <img src="{{ asset('storage/'. $course->photo->imageURL) }}" alt="cover-img" class="w-3/4 mt-4">
        <div class="w-full justify-between flex flex-col">
            <div>
                ...
                <div id="accordion-collapse" data-accordion="collapse"
                    class="max-w-[330px] w-screen border border-1 border-[#3CCAA1]"
                ...
                @endforeach
                @if ($course->creatorID == Auth::user()->id)
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="py-6 px-6 lg:px-8">
                ...
                <form class="space-y-6" action="{{ route('tutor.newSection') }}" method="POST">
                    ...
                    <div>
                        <label for="Section" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">New
                            Section</label>
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="py-6 px-6 lg:px-8">
                ...
                <form class="space-y-6" action="{{ route('tutor.newContent') }}" method="POST"
                    ...
                    @csrf
                    <label for="section" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Content
                        Section</label>
                    ...
                    <div>
                        <label for="text"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Content
                            Title</label>
                    ...
                    <div>
                        ...
                        <input type="text" id="file-cover" name="content"

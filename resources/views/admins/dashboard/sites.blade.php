...
@section('content')
    <h1 class="font-bold text-[32px]">Sites Content</h1>
    <form action="#" method="POST" class="flex flex-row justify-between mt-[46px] space-x-10"
        ...
        <div class="flex flex-col w-1/2">
            ...
            <button
                class="ml-auto bg-[#50CFAB] rounded-lg font-semibold text-lg items-center w-[174px] flex flex-row justify-center text-center py-3 text-white hover:bg-[#4ABA9A] transition-all ease-in-out duration-300 mt-[92px]">Publish
        </div>
    </form>
@endsection

...
<div class="flex flex-row flex-wrap mt-7 space-x-10">
    ...
    <div class="w-1/4">
        ...
        <div class="bg-white py-[21px] px-[30px]">
            ...
            <h2 class="font-light text-lg">Discount Price : Rp. {{ $datas->price * ($datas->discount->discounts/100) }}
            </h2>
            @endif
                ...
                <div class="py-6 px-6 lg:px-8">
                    ...
                    <form action="{{ route('tutor.editCourse') }}" method="POST"
                        ...
                        <div class="flex flex-col w-1/2">
                            ...
                            <textarea name="subtitle" name="subtitle" cols="30" rows="5"
                                class="bg-white border-0 mt-[19px]" placeholder="{{ $datas->description }}"></textarea>
                            ...
                            <button class="w-full mt-5" type="button" data-modal-toggle="authentication-modal">Add More
                                Type</button>
                            @if ($errors->has('type'))
                        ...
                        <div class="flex flex-col w-1/2">
                            ...
                            <input type="number" step="0.01" name="price" class="bg-white border-0 mt-[17px] w-1/3"
                            ...
                            <button class="w-full mt-5" type="button" data-modal-toggle="discount-modal">Add New
                                Discount</button>
                            @if ($errors->has('type'))
                            <p class="mt-2 text-sm text-red-600">{{ $errors->first('type') }}</p>
                            @endif
                            <label for="Upload Documentation" class="font-medium text-xl ml-[20px] mt-[27px]">Upload
                                Documentation</label>
                            <input type="file" id="file-cover" name="cover" class="bg-white border-0 mt-[19px]"
        ...
        <div class="relative p-4 w-[617px] h-full md:h-auto">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="py-6 px-8 text-center items-center flex flex-col">
                    <h3 class="mb-2 text-2xl font-medium text-[#23262F] mt-4">Apakah anda yakin ingin menghapus plan
                        ini?</h3>

            ...
            <div class=" md:col-end-4">
                ...
                <form class="py-10 w-100" method="post" action="{{ route('register') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input name="password_confirm" type="password" class="form-control" required value="{{ old('password_confirm')}}">
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputPassword1" class="form-label">Phone</label>
                        <input name="phone" type="phone" class="form-control" required value="{{ old('phone')}}">
                    </div>
                    ...
                    <button class="w-full" type=" submit" id="btn-gg">
                        <a class="btn btn-outline-dark w-full" href="/users/googleauth" role="button" style="text-transform:none">

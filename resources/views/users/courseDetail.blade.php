...
@section('content')
    <div class="flex flex-col flex-nowrap">
        ...
        <div class="bg-white mt-12 flex flex-col justify-between h-auto">
            <img src="{{ asset('storage/' . $course->photo->imageURL) }}"
                class="w-1/2 mt-4 justify-between items-center mx-auto" alt="Class Cover" />
            ...
            <form class="border-1 border py-7 pr-[65px] items-end mt-10 justify-end flex flex-col"
                ...
                <button type="submit"
                    class="mt-5 bg-white rounded-full hover:bg-[#3CCAA1] border-1 border border-[#3CCAA1] focus:bg-[#3CCAA1] active:bg-[#3CCAA1] hover:text-white focus:text-white active:text-white py-2 px-5 font-light hover:font-bold active:font-bold focus:font-bold text-lg w-auto duration-500 ease-in-out transition-all">Payment
                    -></button>
            </form>
        </div>
    </div>

        ...
        <div class="flex flex-row mt-11 justify-between space-x-10">
            ...
            <div class="w-full justify-between flex flex-col">
                <div>
                    ...
                    <div id="accordion-collapse" data-accordion="collapse" class="border border-1 border-[#3CCAA1] rounded-t-lg mt-4" data-active-classes="bg-[#3CCAA1]/30 text-black">
                        <h2 id="accordion-collapse-heading-1" class="bg-[#3CCAA1]/30">
                          <button type="button" class="flex items-center justify-between w-full py-2 px-5 text-left rounded-t-lg text-black" data-accordion-target="#accordion-collapse-body-1" aria-expanded="true" aria-controls="accordion-collapse-body-1">
                        ...
                        <div id="accordion-collapse-body-1" aria-labelledby="accordion-collapse-heading-1" class="bg-[#3CCAA1]/10">

        ...
        <a href="{{ route('user.courseDetail', $courses->id) }}">
            <div class="max-w-[318px] w-full mr-[37px] mb-[31px] rounded-md border-[#7C7C7C] border-[1px]">
                ...
                <div class="bg-white py-[18px] px-[20px]">
                    ...
                    <div
                        class="flex flex-row flex-nowrap justify-between items-center mt-1"
                    >
                        ...
                        <div class="flex flex-row items-center">
                            <img
                                src="{{
                                    asset('images/guest-icon/star-icon.svg')
                                }}"
                                alt="star-icon"
                            ...
                            <span
                                ...
                                >{{ $courses->reviews }}</span
                            >
                            <span class="font-light text-base"
                                >({{ $courses->courseReview->count() }})</span
                            >
                        </div>
                    </div>
                </div>

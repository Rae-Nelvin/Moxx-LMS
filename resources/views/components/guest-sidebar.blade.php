    ...
    <div class="overflow-y-hidden bg-white h-screen py-6 px-4">
        ...
        <ul class="mt-11 space-y-[20px]">
            @if (Auth::user()->roleID == 1)
                ...
                <li>
                    <a href="{{ route('admin.renderPayment') }}"
                ...
                <li>
                    <a href="{{ route('admin.renderUserList') }}"
                ...
                <li>
                    <a href="{{ route('admin.renderCreateCourse') }}"
                ...
                <li>
                    <a href="{{ route('admin.renderPlans') }}"
        ...
        <ul class="mt-14 space-y-[20px]">
            <li>
                <a href="{{ route('settings') }}"
                    class="{{ request()->is('settings') ? 'flex items-center rounded-md bg-[#3CCAA1] py-2 px-4 w-full text-white' : 'flex items-center rounded-md hover:bg-[#3CCAA1] py-2 px-4 w-full text-[#7C7C7C] transition-colors ease-in-out duration-300 hover:text-white' }}">

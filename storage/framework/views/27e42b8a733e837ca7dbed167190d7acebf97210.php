...
<body class="antialiased">
    <div
        ...
        <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
            ...
            <a href="<?php echo e(url('/login')); ?>" class="text-sm text-gray-700 dark:text-gray-500 underline">log out</a>
            <?php else: ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a href="<?php echo e(route('login')); ?>"
...
</html><?php /**PATH D:\xampp\htdocs\LMS\resources\views/welcome.blade.php ENDPATH**/ ?>